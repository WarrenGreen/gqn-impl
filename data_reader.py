...
Context = collections.namedtuple('Context', ['frames', 'cameras'])  # np.array: (batch_size, context_size, img_width, img_height, img_channel), (batch_size, context_size, 7)
Query = collections.namedtuple('Query', ['context', 'query_camera'])  # Context, np.array( batch_size, 7)
TaskData = collections.namedtuple('TaskData', ['query', 'target'])  # Query, np.array: (batch_size, img_width, img_height, img_channel)
